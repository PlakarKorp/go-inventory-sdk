...
require (
	...
	github.com/PlakarKorp/integrations/fs v1.1.0-beta.8 // indirect
	github.com/PlakarKorp/integrations/ptar v1.1.0-beta.4 // indirect
	github.com/PlakarKorp/kloset v1.1.0-rc.4 // indirect
